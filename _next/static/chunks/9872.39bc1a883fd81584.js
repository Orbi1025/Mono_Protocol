...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    19872: (e, t, i) => {
      i.r(t), i.d(t, { W3mWalletReceiveView: () => $ });
      var r = i(83138),
        o = i(98410),
        a = i(78964),
        n = i(93481),
...
`;
    ...
    `;
      ...
      (b.styles = [h.W5, h.fD, g]),
        k([(0, o.MZ)({ type: Array })], b.prototype, "networkImages", void 0),
        k([(0, o.MZ)()], b.prototype, "text", void 0),
        (b = k([(0, m.E)("wui-compatible-network")], b)),
        i(40575),
        i(34563),
        i(41163);
      var y = i(73537);
...
`;
      ...
      let $ = class extends r.WF {
        constructor() {
          super(),
            (this.unsubscribe = []),
            (this.address = n.W.getAccountData()?.address),
            (this.profileName = n.W.getAccountData()?.profileName),
            (this.network = n.W.state.activeCaipNetwork),
            this.unsubscribe.push(
              n.W.subscribeChainProp("accountState", (e) => {
                e
                  ? ((this.address = e.address),
                    (this.profileName = e.profileName))
                  : s.P.showError("Account not found");
              }),
        ...
        render() {
          ...
          let e = c.$.getNetworkImage(this.network);
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${(0, a.J)(l.W.state.themeVariables["--w3m-qr-color"])}
      ...
      ${this.networkTemplate()}
        ...
        networkTemplate() {
          let e = n.W.getAllRequestedCaipNetworks(),
            ...
            o = e.filter((e) => e?.chainNamespace === i?.chainNamespace);
          if (
            (0, u.lj)(i?.chainNamespace) === y.Vl.ACCOUNT_TYPES.SMART_ACCOUNT &&
            t
          )
            return i
    ...
    ></wui-compatible-network>`;
        ...
        onReceiveClick() {
          d.I.push("WalletCompatibleNetworks");
        }
        onCopyClick() {
          try {
            this.address &&
              (w.w.copyToClopboard(this.address),
              s.P.showSuccess("Address copied"));
          } catch {
      ...
      ($.styles = v),
        x([(0, o.wk)()], $.prototype, "address", void 0),
        x([(0, o.wk)()], $.prototype, "profileName", void 0),
        x([(0, o.wk)()], $.prototype, "network", void 0),
        ($ = x([(0, p.EM)("w3m-wallet-receive-view")], $));
    },
  },
]);
