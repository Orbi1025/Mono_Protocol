...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [837],
  {
    20837: (t, e, r) => {
      ...
      let l = (t, e, r) => new o(t, e).update(r).digest();
      l.create = (t, e) => new o(t, e);
      let f = BigInt(0),
        s = BigInt(1);
      function a(t) {
        return (
      ...
      function E(t) {
        ...
        for (let e = 0, i = 0; e < r; e++, i += 2) {
          let r = w(t.charCodeAt(i)),
            o = w(t.charCodeAt(i + 1));
      ...
      function v(t) {
        return u(t), c(y(Uint8Array.from(t).reverse()));
      }
      function B(t, e) {
        return E(t.toString(16).padStart(2 * e, "0"));
      }
      function x(t, e) {
      ...
      let I = (t) => "bigint" == typeof t && f <= t;
      function O(t, e, r) {
        return I(t) && I(e) && I(r) && e <= t && t < r;
      }
      function R(t, e, r, n) {
        if (!O(e, r, n))
          throw Error(
      ...
      let q = (t) => (s << BigInt(t)) - s,
        N = (t) => new Uint8Array(t),
        H = (t) => Uint8Array.from(t),
        z = {
      ...
      function D(t, e) {
        if (t === P) throw Error("invert: expected non-zero number");
        if (e <= P) throw Error("invert: expected positive modulus, got " + e);
        let r = V(t, e),
          n = e,
          i = P,
          o = Z,
      ...
      function Q(t, e, r = !1, n = {}) {
        let i;
        if (t <= P) throw Error("invalid field: expected ORDER > 0, got " + t);
        let { nBitLength: o, nByteLength: l } = J(t, e);
        if (l > 2048)
        ...
        let f = Object.freeze({
          ...
          pow: (t, e) =>
            (function (t, e, r) {
              if (r < P) throw Error("invalid exponent, negatives unsupported");
              if (r === P) return t.ONE;
              if (r === Z) return e;
              let n = t.ONE,
                i = e;
              for (; r > P; )
                r & Z && (n = t.mul(n, i)), (i = t.sqr(i)), (r >>= Z);
              return n;
            })(f, t, e),
          div: (e, r) => V(e * D(r, t), t),
          sqrN: (t) => t * t,
      ...
      function ta(t) {
        return (
          ...
          Object.freeze({ ...J(t.n, t.nBitLength), ...t, ...{ p: t.Fp.ORDER } })
        );
      }
      function tu(t) {
        void 0 !== t.lowS && d("lowS", t.lowS),
          void 0 !== t.prehash && d("prehash", t.prehash);
      }
        ...
        tx = Q(tm, void 0, void 0, {
          sqrt: function (t) {
            let e = BigInt(3),
              ...
              b = (j(E, r, tm) * s) % tm,
              v = j(b, tv, tm);
            if (!tx.eql(tx.sqr(v), t)) throw Error("Cannot find square root");
            return v;
          },
        }),
        tA = (function (t, e) {
          let r = (e) =>
            (function (t) {
              let e = (function (t) {
                ...
                { Fp: r, n: n, nByteLength: i, nBitLength: o } = e,
                l = r.BYTES + 1,
                u = 2 * r.BYTES + 1;
              function h(t) {
                return V(t, n);
              ...
              let {
                  ...
                  let c = n.mul(n.pow(r.a, tp), ty),
                    g = n.mul(n.sqr(r.b), BigInt(27));
                  if (n.is0(n.add(c, g)))
                  ...
                  function p(t) {
                    ...
                    try {
                      e = "bigint" == typeof t ? t : b(A("private key", t, i));
                    } catch (e) {
                      throw Error(
                    ...
                    return o && (e = V(e, l)), R("private key", e, tg, l), e;
                  }
                  function m(t) {
                    if (!(t instanceof v))
                  ...
                  class v {
                    constructor(t, e, r) {
                      if (null == t || !n.isValid(t)) throw Error("x required");
                    ...
                    static fromAffine(t) {
                      ...
                      return i(e) && i(r) ? v.ZERO : new v(e, r, n.ONE);
                    }
                    get x() {
                    ...
                    static fromHex(t) {
                      let e = v.fromAffine(l(A("pointHex", t)));
                      return e.assertValidity(), e;
                    }
                    static fromPrivateKey(t) {
                      return v.BASE.multiply(p(t));
                    }
                    static msm(t, e) {
                      return (function (t, e, r, n) {
                        ...
                        a > 12
                          ...
                          : a > 0 && (u = 2);
                        let d = q(u),
                          h = Array(Number(d) + 1).fill(l),
                          c = Math.floor((e.BITS - 1) / u) * u,
                          g = l;
                        for (let t = c; t >= 0; t -= u) {
                          h.fill(l);
                          for (let e = 0; e < o; e++) {
                            let i = Number((n[e] >> BigInt(t)) & d);
                            h[i] = h[i].add(r[e]);
                          }
                          let e = l;
                          ...
                          if (((g = g.add(e)), 0 !== t))
                            for (let t = 0; t < u; t++) g = g.double();
                        }
                        return g;
                      })(v, i, t, e);
                    }
                    _setWindowSize(t) {
                      I.setWindowSize(this, t);
                    }
                    assertValidity() {
                      E(this);
                    }
                    ...
                    wNAF(t) {
                      return I.wNAFCached(this, t, v.normalizeZ);
                    }
                    multiplyUnsafe(t) {
                      let { endo: e, n: i } = r;
                      R("scalar", t, tc, i);
                      let o = v.ZERO;
                      if (t === tc) return o;
                      if (this.is0() || t === tg) return this;
                      if (!e || I.hasPrecomputes(this))
                        return I.wNAFCachedUnsafe(this, t, v.normalizeZ);
                      let {
                          k1neg: l,
                          k1: f,
                          k2neg: s,
                      ...
                      return (
                        l && (u = u.negate()),
                        s && (d = d.negate()),
                        (d = new v(n.mul(d.px, e.beta), d.py, d.pz)),
                        u.add(d)
                      );
                    }
                    multiply(t) {
                      ...
                      if ((R("scalar", t, tg, l), o)) {
                        let {
                          ...
                          { p: a, f: u } = this.wNAF(l),
                          { p: d, f: h } = this.wNAF(s);
                        (a = I.constTimeNegate(r, a)),
                          (d = I.constTimeNegate(f, d)),
                          (d = new v(n.mul(d.px, o.beta), d.py, d.pz)),
                          (e = a.add(d)),
                          (i = u.add(h));
                      } else {
                      ...
                      return v.normalizeZ([e, i])[0];
                    }
                    multiplyAndAddUnsafe(t, e, r) {
                      let n = v.BASE,
                        i = (t, e) =>
                          e !== tc && e !== tg && t.equals(n)
                            ? t.multiply(e)
                            : t.multiplyUnsafe(e),
                    ...
                    toHex(t = !0) {
                      return d("isCompressed", t), y(this.toRawBytes(t));
                    }
                  }
                  (v.BASE = new v(r.Gx, r.Gy, n.ONE)),
                    (v.ZERO = new v(n.ZERO, n.ONE, n.ZERO));
                  let { endo: B, nBitLength: x } = r,
                    I =
                      ((e = B ? Math.ceil(x / 2) : x),
                      {
                        constTimeNegate: tr,
                        hasPrecomputes: (t) => 1 !== ts(t),
                        unsafeLadder(t, e, r = v.ZERO) {
                          let n = t;
                          for (; e > tt; )
                            e & te && (r = r.add(n)),
                              (n = n.double()),
                        ...
                        precomputeWindow(t, r) {
                          let { windows: n, windowSize: i } = ti(r, e),
                            o = [],
                            l = t,
                            f = l;
                          for (let t = 0; t < n; t++) {
                        ...
                        wNAFUnsafe(t, r, n, i = v.ZERO) {
                          let o = ti(t, e);
                          for (let t = 0; t < o.windows && n !== tt; t++) {
                            let {
                              nextN: e,
                              offset: l,
                              isZero: f,
              ...
              class I {
                ...
                static fromCompact(t) {
                  return new I(
                    w((t = A("compactSignature", t, 2 * i)), 0, i),
                    w(t, i, 2 * i)
                  );
                }
                static fromDER(t) {
                  let { r: e, s: r } = th.toSig(A("DER", t));
                  return new I(e, r);
                }
                assertValidity() {}
                addRecoveryBit(t) {
                ...
                recoverPublicKey(t) {
                  ...
                  let s = 2 === l || 3 === l ? i + e.n : i;
                  if (s >= r.ORDER) throw Error("recovery id 2 or 3 invalid");
                  let a = (1 & l) == 0 ? "02" : "03",
                    u = c.fromHex(a + y(B(s, r.BYTES))),
                    d = D(s, n),
                    g = h(-f * d),
                    p = h(o * d),
                    m = c.BASE.multiplyAndAddUnsafe(u, g, p);
                ...
                toDERRawBytes() {
                  return E(this.toDERHex());
                }
                toDERHex() {
                  return th.hexFromSig(this);
                }
                toCompactRawBytes() {
                  return E(this.toCompactHex());
                }
                toCompactHex() {
                  return y(B(this.r, i)) + y(B(this.s, i));
                }
              }
              function z(t) {
                if ("bigint" == typeof t) return !1;
                if (t instanceof c) return !0;
                let n = A("key", t).length,
                  o = r.BYTES,
                  l = o + 1;
                if (!e.allowedPrivateKeyLengths && i !== l)
                  return n === l || n === 2 * o + 1;
              }
              let P =
                  e.bits2int ||
              ...
              return (
                c.BASE._setWindowSize(8),
                {
                  ...
                  getSharedSecret: function (t, e, r = !0) {
                    ...
                    return c.fromHex(e).multiply(g(t)).toRawBytes(r);
                  },
                  sign: function (t, i, o = k) {
                    let { seed: l, k2sig: f } = (function (t, i, o = k) {
                      if (["recovered", "canonical"].some((t) => t in o))
                        throw Error("sign() legacy options not supported");
                      let { hash: l, randomBytes: f } = e,
                        { lowS: s, prehash: a, extraEntropy: u } = o;
                      null == s && (s = !0),
                        (t = A("msgHash", t)),
                        tu(o),
                        a && (t = A("prehashed msgHash", l(t)));
                      let d = C(t),
                        p = g(i),
                        y = [_(p), _(d)];
                      if (null != u && !1 !== u) {
                        let t = !0 === u ? f(r.BYTES) : u;
                        y.push(A("extraEntropy", t));
                      }
                      return {
                        seed: S(...y),
                        k2sig: function (t) {
                          ...
                          let f = h(i * h(d + l * p));
                          if (f === tc) return;
                          let a = (2 * (o.x !== l)) | Number(o.y & tg),
                            u = f;
                          return (
                            s &&
                              f > n >> tg &&
                              ((u = (e = f) > n >> tg ? h(-e) : e), (a ^= 1)),
                            new I(l, u, a)
                          );
                        },
                      };
                  ...
                  verify: function (t, r, i, o = T) {
                    ...
                    try {
                      if ((p && (f = new I(t.r, t.s)), g)) {
                        try {
                          "compact" !== d && (f = I.fromDER(t));
                        } catch (t) {
                          if (!(t instanceof th.Err)) throw t;
                        }
                        f || "der" === d || (f = I.fromCompact(t));
                      }
                      l = c.fromHex(i);
                    } catch (t) {
                      return !1;
                    ...
                    let { r: y, s: m } = f,
                      ...
                      b = h(w * E),
                      v = h(y * E),
                      B = c.BASE.multiplyAndAddUnsafe(l, b, v)?.toAffine();
                    return !!B && h(B.x) === y;
                  },
                  ProjectivePoint: c,
                  Signature: I,
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (t, e, r = !1) {
                        ...
                        let l = V(r ? v(t) : b(t), e - Z) + Z;
                        return r ? x(l, i) : B(l, i);
                      })(e.randomBytes(t), e.n);
                    },
            ...
            endo: {
              ...
              splitScalar: (t) => {
                let e = BigInt("0x3086d221a7d46bcde86c90e49284eb15"),
                  r = -tb * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"),
