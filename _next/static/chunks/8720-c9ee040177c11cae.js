    ...
    18720: (t, e, a) => {
          ...
          (this.subscribe = (t) => (
                  ...
                  ? (this.toasts = this.toasts.map((e) =>
                      e.id === r
                        ? (this.publish({ ...e, ...t, id: r, title: a }),
                          { ...e, ...t, id: r, dismissible: s, title: a })
                        : e
                    ))
                  : this.addToast({ title: a, ...o, dismissible: s, id: r }),
                r
              );
            }),
            (this.dismiss = (t) => (
            ...
            (this.promise = (t, e) => {
              ...
              let n = Promise.resolve(t instanceof Function ? t() : t),
                ...
                i = n
                  .then(async (t) => {
                    if (((a = ["resolve", t]), o.isValidElement(t)))
                      (s = !1),
                      ...
                      let a =
                        ...
                        n =
                          "function" == typeof e.description
                            ...
                            : e.description,
                        i =
                          "object" != typeof a || o.isValidElement(a)
                            ? { message: a }
                            : a;
                      this.create({
                        id: r,
      ...
      let p = new f(),
        ...
        g = Object.assign(
          (t, e) => {
            let a = (null == e ? void 0 : e.id) || m++;
            return p.addToast({ title: t, ...e, id: a }), a;
          },
          {
            success: p.success,
            info: p.info,
      ...
      let y = (t) => {
        ...
        let {
          ...
          ty = o.useMemo(
            () => T.findIndex((t) => t.toastId === E.id) || 0,
            [T, E.id]
          ),
          tw = o.useMemo(() => {
            var t;
            return null != (t = E.closeButton) ? t : Y;
          }, [E.closeButton, Y]),
          tx = o.useMemo(() => E.duration || H || 4e3, [E.duration, H]),
          tE = o.useRef(0),
          tk = o.useRef(0),
          tN = o.useRef(0),
          tM = o.useRef(null),
          [tS, tT] = V.split("-"),
          tB = o.useMemo(
            () => T.reduce((t, e, a) => (a >= ty ? t : t + e.height), 0),
            [T, ty]
          ),
          tC = (() => {
          ...
          tz = E.invert || x,
          tj = "loading" === th;
        (tk.current = o.useMemo(() => ty * X + tB, [ty, tB])),
          o.useEffect(() => {
            tc.current = tx;
          }, [tx]),
          o.useEffect(() => {
          ...
          }, [G, E.title, E.description, M, E.id, E.jsx, E.action, E.cancel]);
        ...
        return o.createElement(
          "li",
          {
            ...
            className: v(
              ...
              null == F ? void 0 : F[th],
              null == E || null == (a = E.classNames) ? void 0 : a[th]
            ),
            "data-sonner-toast": "",
            "data-rich-colors": null != (y = E.richColors) ? y : R,
            ...
            style: {
              ...
              "--toasts-before": B,
              "--z-index": C.length - B,
              "--offset": "".concat(Q ? ts : tk.current, "px"),
              "--initial-height": U ? "auto" : "".concat(tl, "px"),
              ...D,
              ...E.style,
            },
            onDragEnd: () => {
              te(!1), q(null), (tM.current = null);
            },
            onPointerDown: (t) => {
              2 !== t.button &&
                !tj &&
                ...
                "BUTTON" !== t.target.tagName &&
                  (te(!0), (tM.current = { x: t.clientX, y: t.clientY })));
            },
            onPointerUp: () => {
              var t, e, a, o, r;
              if (ta || !tg) return;
              ...
              let n = Number(
                ...
                i =
                  new Date().getTime() -
                  (null == (a = tu.current) ? void 0 : a.getTime()),
                l = "x" === K ? n : s,
                d = Math.abs(l) / i;
            ...
            onPointerMove: (e) => {
                ...
                l =
                  null != (n = t.swipeDirections)
                    ...
                    : (function (t) {
                        let [e, a] = t.split("-"),
                          o = [];
                        return e && o.push(e), a && o.push(a), o;
                      })(V);
              !K &&
                (Math.abs(i) > 1 || Math.abs(s) > 1) &&
                q(Math.abs(i) > Math.abs(s) ? "x" : "y");
              let d = { x: 0, y: 0 },
              ...
              (Math.abs(d.x) > 0 || Math.abs(d.y) > 0) && tn(!0),
                null == (o = tm.current) ||
                  o.style.setProperty("--swipe-amount-x", "".concat(d.x, "px")),
                null == (r = tm.current) ||
                  r.style.setProperty("--swipe-amount-y", "".concat(d.y, "px"));
            },
          },
          tw && !E.jsx && "loading" !== th
            ? o.createElement(
                "button",
                {
                  ...
                  className: v(
                    ...
                    null == E || null == (r = E.classNames)
                      ? void 0
                      : r.closeButton
                  ),
                },
                null != (w = null == O ? void 0 : O.close) ? w : u
              )
            : null,
          (th || E.icon || E.promise) &&
            null !== E.icon &&
            ((null == O ? void 0 : O[th]) !== null || E.icon)
            ? o.createElement(
                "div",
                {
                  "data-icon": "",
                  className: v(
                    ...
                    null == E || null == (n = E.classNames) ? void 0 : n.icon
                  ),
                },
          ...
          o.createElement(
            "div",
            {
              ...
              className: v(
                ...
                null == E || null == (m = E.classNames) ? void 0 : m.content
              ),
            },
            o.createElement(
              "div",
                ...
                "button",
                {
                  ...
                  onClick: (t) => {
                    b(E.action) &&
                      ...
                      t.defaultPrevented || tR());
                  },
                  className: v(
                    null == F ? void 0 : F.actionButton,
                    null == E || null == (g = E.classNames)
                      ? void 0
                      : g.actionButton
                  ),
                },
      ...
      let x = o.forwardRef(function (t, e) {
        let {
            id: a,
            invert: n,
          ...
          B = o.useMemo(
            () =>
              a
                ? S.filter((t) => t.toasterId === a)
                : S.filter((t) => !t.toasterId),
            [S, a]
          ),
          C = o.useMemo(
            () =>
              Array.from(
                new Set(
                  [s].concat(B.filter((t) => t.position).map((t) => t.position))
                )
              ),
            [B, s]
          ),
                ...
                ? o.createElement(
                    "ol",
                    {
                      ...
                      onFocus: (t) => {
                        !(
                          ...
                          (X.current ||
                            ((X.current = !0), (V.current = t.relatedTarget)));
                      },
                      onMouseEnter: () => Y(!0),
                      onMouseMove: () => Y(!0),
                      onMouseLeave: () => {
                    ...
                    B.filter(
                      ...
                      return o.createElement(y, {
                        ...
                        defaultRichColors: h,
                        duration:
                          null != (s = null == x ? void 0 : x.duration) ? s : g,
                        ...
                        removeToast: U,
                        toasts: B.filter((t) => t.position == a.position),
