  ...
  [5024],
  {
    ...
    7799: (e, t, n) => {
      ...
      async function u(e, t) {
        let { account: n = e.account, chainId: u, nonce: l } = t;
        if (!n)
          throw new a.T({ docsPath: "/docs/eip7702/prepareAuthorization" });
        let d = (0, r.J)(n),
          f = (() => {
            if (t.executor)
              return "self" === t.executor ? t.executor : (0, r.J)(t.executor);
          })(),
          p = { address: t.contractAddress ?? t.address, chainId: u, nonce: l };
        return (
          void 0 === p.chainId &&
            (p.chainId =
          ...
          void 0 === p.nonce &&
            ...
            ("self" === f || (f?.address && (0, i.h)(f.address, d.address))) &&
              (p.nonce += 1)),
          p
        );
      }
        ...
        let n,
          {
            ...
            status: h = ({ statusCode: e }) => 200 === e || e >= 300,
            retryCount: m = 4,
            retryDelay: y = ({ count: e }) => 200 * ~~(1 << e),
            timeout: g = 6e4,
            throwOnFailure: b = !1,
          } = t,
          w = (0, l.A)(["waitForCallsStatus", e.uid, r]),
          { promise: v, resolve: _, reject: x } = (0, c.Y)(),
          k = (0, s.lB)(w, { resolve: _, reject: x }, (t) => {
            let s = (0, o.w)(
              async () => {
                let o = (e) => {
                  clearTimeout(n), s(), e(), k();
                };
                try {
                  let n = await (0, u.b)(
                    async () => {
                      ...
                      if (b && "failure" === t.status) throw new a(t);
                      return t;
                    },
    ...
    48656: (e, t, n) => {
      ...
      function i(e) {
        ...
        return (0, r.U)({ ...e, key: t, name: n, type: "publicClient" }).extend(
          a.$
        );
      }
    },
    ...
    55794: (e, t, n) => {
      ...
      async function h(e, t) {
        let {
            ...
            capabilities: h,
            chain: m = e.chain,
            experimental_fallback: y,
            experimental_fallbackDelay: g = 32,
            forceAtomic: b = !1,
            id: w,
            version: v = "2.0.0",
          } = t,
          ...
          x = t.calls.map((e) => {
            ...
            return {
              ...
              to: e.to,
              value: e.value ? (0, u.cK)(e.value) : void 0,
            };
          });
        try {
          ...
          if (
            ...
            ("MethodNotFoundRpcError" === n.name ||
              ...
              n.details.toLowerCase().includes("feature toggled misconfigured"))
          ) {
            if (h && Object.values(h).some((e) => !e.optional)) {
              let e =
                "non-optional `capabilities` are not supported on fallback to `eth_sendTransaction`.";
              throw new i.L5(new a.C(e, { details: e }));
            }
            if (b && x.length > 1) {
              let e =
                "`forceAtomic` is not supported on fallback to `eth_sendTransaction`.";
              throw new i.jz(new a.C(e, { details: e }));
            }
            let t = [];
            for (let n of x) {
              let r = (0, d.v)(e, {
                ...
                data: n.data,
                to: n.to,
                value: n.value ? (0, c.uU)(n.value) : void 0,
              });
              t.push(r), g > 0 && (await new Promise((e) => setTimeout(e, g)));
            }
            let n = await Promise.allSettled(t);
            if (n.every((e) => "rejected" === e.status)) throw n[0].reason;
            let r = n.map((e) => ("fulfilled" === e.status ? e.value : p));
            return { id: (0, o.xW)([...r, (0, u.cK)(m.id, { size: 32 }), f]) };
          }
          throw (0, l.p)(n, { ...t, account: _, chain: t.chain });
        }
      }
    },
    75024: (e, t, n) => {
      "use strict";
      n.d(t, { createCoinbaseWalletSDK: () => sT });
      var r,
        a,
        i,
        s,
      ...
      let d = (e) => (t) => {
        ...
        b = Object.assign(Object.assign({}, y), {
          subAccounts: {
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
            ...
            r.logEvent(
              ...
              Object.assign(Object.assign({}, t), {
                ...
                appName:
                  null !=
                  (i =
                    null == (a = b.config.get().metadata) ? void 0 : a.appName)
                    ? i
                    : "",
                appOrigin: window.location.origin,
                appPreferredSigner:
                  null == (s = b.config.get().preference) ? void 0 : s.options,
              }),
              n
            ));
      }
      ...
      function eL(e) {
        ...
        if ("number" == typeof e) return BigInt(eM(e));
        if ("string" == typeof e) {
      ...
      Object.defineProperty(tx, "message", {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: /aa40/,
      ...
      let tC = [eX, tt, tr, ts, to, tl, tf, tv, tg, tb, tw];
        ...
        return new tS(
          (() => {
            let n = (function (e, t) {
              ...
              if (tx.message.test(n)) return new tx({ cause: e });
      ...
      async function tq(e, t) {
        let n,
          { account: r = e.account, parameters: a = tR, stateOverride: i } = t;
        if (!r) throw new e$.T();
        let s = (0, eW.J)(r),
            ...
            if (!0 === o)
              return {
                getPaymasterStubData: (t) =>
                  (0, eK.T)(e, tU, "getPaymasterStubData")(t),
                getPaymasterData: (t) =>
                  (0, eK.T)(e, tB, "getPaymasterData")(t),
              };
            if ("object" == typeof o) {
          ...
          [h, m, y, g, b] = await Promise.all([
            ...
            (async () => {
              ...
              return "0.6" === s.entryPoint.version
                ? { initCode: e && n ? (0, tD.xW)([e, n]) : void 0 }
            ...
            (async () => {
              if (a.includes("authorization")) {
                ...
                if (s.authorization && !(await s.isDeployed()))
                  return {
                    ...(await (0, tL.h)(s.client, s.authorization)),
      ...
      async function tF(e, t) {
        ...
        let i = n ? (0, eW.J)(n) : void 0,
          ...
          o = i
            ...
            : t;
        try {
          let t = [tM(o), r ?? i?.entryPoint?.address];
      ...
      async function tW(e, { hash: t }) {
        ...
        return (
          ...
          n.logs && (r.logs = n.logs.map((e) => (0, tG.e)(e))),
          n.receipt && (r.receipt = (0, tz.uL)(r.receipt)),
          r
        );
      }
      async function t$(e, t) {
        ...
        let a = n ? (0, eW.J)(n) : void 0,
          i = a ? await (0, eK.T)(e, tq, "prepareUserOperation")(t) : t,
      ...
      function tJ(e) {
        return {
          ...
          getUserOperation: (t) => tH(e, t),
          getUserOperationReceipt: (t) => tW(e, t),
          prepareUserOperation: (t) => tq(e, t),
          sendUserOperation: (t) => t$(e, t),
          waitForUserOperationReceipt: (t) =>
            (function (e, t) {
              let {
                ...
                s = 0,
                o = (0, tZ.A)(["waitForUserOperationReceipt", e.uid, n]);
              return new Promise((t, c) => {
                let u = (0, tK.lB)(o, { resolve: t, reject: c }, (t) => {
                  let o = (e) => {
                      c(), e(), u();
                    },
                    c = (0, tV.w)(
      ...
      function tY(e) {
        e.forEach((e) => {
          ...
          let u = (0, eq.x)({
            ...
            l = (0, eF.l)({ chain: u, transport: (0, eH.L)(e.rpcUrl) }),
            d = (function (e) {
              let {
                client: t,
                key: n = "bundler",
            ...
            })({ client: l, transport: (0, eH.L)(e.rpcUrl) });
          tQ.setState({ [e.id]: { client: l, bundlerClient: d } });
        });
      }
      function tX(e) {
        var t;
        return null == (t = tQ.getState()[e]) ? void 0 : t.client;
      }
      var t0 = n(24784),
        t1 = n(60587);
      function t2(e) {
      ...
      async function t4(e, { iv: t, cipherText: n }) {
      ...
      async function nt(e, t) {
        return JSON.parse(await t4(t, e));
      }
      let nn =
        "object" == typeof globalThis && "crypto" in globalThis
          ? globalThis.crypto
      ...
      let nd =
        ...
        nf = Array.from({ length: 256 }, (e, t) =>
          t.toString(16).padStart(2, "0")
        );
      function np(e) {
        if ((ni(e), nd)) return e.toHex();
        let t = "";
        for (let n = 0; n < e.length; n++) t += nf[e[n]];
        return t;
      }
      let nh = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function nm(e) {
        return e >= nh._0 && e <= nh._9
          ? e - nh._0
          : e >= nh.A && e <= nh.F
          ? e - (nh.A - 10)
          : e >= nh.a && e <= nh.f
      ...
      function ny(e) {
        ...
        let r = new Uint8Array(n);
        for (let t = 0, a = 0; t < n; t++, a += 2) {
          let n = nm(e.charCodeAt(a)),
            i = nm(e.charCodeAt(a + 1));
          if (void 0 === n || void 0 === i)
            throw Error(
              'hex string expected, got non-hex character "' +
                (e[a] + e[a + 1]) +
      ...
      function n_(e = 32) {
        if (nn && "function" == typeof nn.getRandomValues)
          return nn.getRandomValues(new Uint8Array(e));
        if (nn && "function" == typeof nn.randomBytes)
          return Uint8Array.from(nn.randomBytes(e));
        throw Error("crypto.getRandomValues must be defined");
      }
      class nx extends nw {
        constructor(e, t, n, r) {
      ...
      let nk = Uint32Array.from([
        ...
        nS = BigInt(0x100000000 - 1),
        nI = BigInt(32),
        nO = (e, t, n) => e >>> n,
        nP = (e, t, n) => (e << (32 - n)) | (t >>> n),
        nC = (e, t, n) => (e >>> n) | (t << (32 - n)),
        nT = (e, t, n) => (e << (32 - n)) | (t >>> n),
        nj = (e, t, n) => (e << (64 - n)) | (t >>> (n - 32)),
        nM = (e, t, n) => (e >>> (n - 32)) | (t << (64 - n));
      function nL(e, t, n, r) {
        let a = (t >>> 0) + (r >>> 0);
        return { h: (e + n + ((a / 0x100000000) | 0)) | 0, l: 0 | a };
      }
      let nN = (e, t, n) => (e >>> 0) + (t >>> 0) + (n >>> 0),
        nD = (e, t, n, r) => (t + n + r + ((e / 0x100000000) | 0)) | 0,
        nB = (e, t, n, r) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0),
        nU = (e, t, n, r, a) => (t + n + r + a + ((e / 0x100000000) | 0)) | 0,
        nR = (e, t, n, r, a) =>
          (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (a >>> 0),
        nq = (e, t, n, r, a, i) =>
          (t + n + r + a + i + ((e / 0x100000000) | 0)) | 0,
      ...
      class nG extends nx {
        ...
        process(e, t) {
          for (let n = 0; n < 16; n++, t += 4) nH[n] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = nH[e - 15],
              n = nH[e - 2],
              r = nl(t, 7) ^ nl(t, 18) ^ (t >>> 3),
              a = nl(n, 17) ^ nl(n, 19) ^ (n >>> 10);
            nH[e] = (a + nH[e - 7] + r + nH[e - 16]) | 0;
          }
        ...
        destroy() {
          this.set(0, 0, 0, 0, 0, 0, 0, 0), nc(this.buffer);
        }
      }
      let nz = (function (e, t = !1) {
          let n = e.length,
            r = new Uint32Array(n),
            a = new Uint32Array(n);
          for (let i = 0; i < n; i++) {
            let { h: n, l: s } = (function (e, t = !1) {
              return t
                ? { h: Number(e & nS), l: Number((e >> nI) & nS) }
                : { h: 0 | Number((e >> nI) & nS), l: 0 | Number(e & nS) };
            })(e[i], t);
            [r[i], a[i]] = [n, s];
          }
          return [r, a];
      ...
      class nZ extends nx {
        ...
        process(e, t) {
          for (let n = 0; n < 16; n++, t += 4)
            (nK[n] = e.getUint32(t)), (nV[n] = e.getUint32((t += 4)));
          for (let e = 16; e < 80; e++) {
            let t = 0 | nK[e - 15],
              n = 0 | nV[e - 15],
              r = nC(t, n, 1) ^ nC(t, n, 8) ^ nO(t, n, 7),
              a = nT(t, n, 1) ^ nT(t, n, 8) ^ nP(t, n, 7),
              i = 0 | nK[e - 2],
              s = 0 | nV[e - 2],
              o = nC(i, s, 19) ^ nj(i, s, 61) ^ nO(i, s, 6),
              c = nB(
                a,
                nT(i, s, 19) ^ nM(i, s, 61) ^ nP(i, s, 6),
                nV[e - 7],
                nV[e - 16]
              ),
              u = nU(c, r, o, nK[e - 7], nK[e - 16]);
            (nK[e] = 0 | u), (nV[e] = 0 | c);
          }
          let {
            Ah: n,
          ...
          for (let e = 0; e < 80; e++) {
            let t = nC(l, d, 14) ^ nC(l, d, 18) ^ nj(l, d, 41),
              b = nT(l, d, 14) ^ nT(l, d, 18) ^ nM(l, d, 41),
              w = (l & f) ^ (~l & h),
              v = nR(g, b, (d & p) ^ (~d & m), n$[e], nV[e]),
              _ = nq(v, y, t, w, nW[e], nK[e]),
              x = 0 | v,
              k = nC(n, r, 28) ^ nj(n, r, 34) ^ nj(n, r, 39),
              E = nT(n, r, 28) ^ nM(n, r, 34) ^ nM(n, r, 39),
              A = (n & a) ^ (n & s) ^ (a & s),
              S = (r & i) ^ (r & o) ^ (i & o);
            (y = 0 | h),
              (g = 0 | m),
          ...
          ({ h: n, l: r } = nL(0 | this.Ah, 0 | this.Al, 0 | n, 0 | r)),
            ({ h: a, l: i } = nL(0 | this.Bh, 0 | this.Bl, 0 | a, 0 | i)),
            ({ h: s, l: o } = nL(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | o)),
            ({ h: c, l: u } = nL(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | u)),
            ({ h: l, l: d } = nL(0 | this.Eh, 0 | this.El, 0 | l, 0 | d)),
            ({ h: f, l: p } = nL(0 | this.Fh, 0 | this.Fl, 0 | f, 0 | p)),
            ({ h: h, l: m } = nL(0 | this.Gh, 0 | this.Gl, 0 | h, 0 | m)),
            ({ h: y, l: g } = nL(0 | this.Hh, 0 | this.Hl, 0 | y, 0 | g)),
            this.set(n, r, a, i, s, o, c, u, l, d, f, p, h, m, y, g);
        }
        roundClean() {
          nc(nK, nV);
        }
      ...
      class n0 extends nw {
        constructor(e, t) {
          ...
          this.oHash.update(a), nc(a);
        }
        update(e) {
          return no(this), this.iHash.update(e), this;
        }
        digestInto(e) {
          no(this),
            ni(e, this.outputLen),
      ...
      let n1 = (e, t, n) => new n0(e, t).update(n).digest();
      n1.create = (e, t) => new n0(e, t);
      let n2 = BigInt(0),
        n3 = BigInt(1);
      function n5(e, t = "") {
        if ("boolean" != typeof e)
      ...
      function n8(e) {
        if ("string" != typeof e)
          throw Error("hex string expected, got " + typeof e);
        return "" === e ? n2 : BigInt("0x" + e);
      }
      function n7(e) {
        return ni(e), n8(np(Uint8Array.from(e).reverse()));
      }
      function n9(e, t) {
        return ny(e.toString(16).padStart(2 * t, "0"));
      }
      function re(e, t) {
        return n9(e, t).reverse();
      }
      function rt(e, t, n) {
        let r;
        if ("string" == typeof t)
      ...
      let rn = (e) => "bigint" == typeof e && n2 <= e;
      function rr(e) {
        let t;
        for (t = 0; e > n2; e >>= n3, t += 1);
        return t;
      }
      let ra = (e) => (n3 << BigInt(e)) - n3;
      function ri(e, t, n = {}) {
      ...
      function rb(e, t) {
        if (e === ro) throw Error("invert: expected non-zero number");
        if (t <= ro) throw Error("invert: expected positive modulus, got " + t);
        let n = rg(e, t),
          r = t,
          a = ro,
          i = rc,
        ...
        if (r !== rc) throw Error("invert: does not exist");
        return rg(a, t);
      }
      function rw(e, t, n) {
      ...
      function r_(e, t) {
        let n = (e.ORDER - rf) / rh,
          ...
          a = e.pow(r, n),
          i = e.mul(t, a),
          s = e.mul(e.mul(i, ru), a),
          o = e.mul(i, e.sub(s, e.ONE));
        return rw(e, o, t), o;
      }
      function rx(e) {
        if (e < rl) throw Error("sqrt is not defined for small field");
        let t = e - rc,
          n = 0;
        for (; t % ru === ro; ) (t /= ru), n++;
        let r = ru,
        ...
        return function (e, r) {
          if (e.is0(r)) return r;
          if (1 !== rA(e, r)) throw Error("Cannot find square root");
          let a = n,
            o = e.mul(e.ONE, i),
            c = e.pow(r, t),
            u = e.pow(r, s);
      ...
      function rI(e, t, n = !1, r = {}) {
        let a, i, s, o;
        if (e <= ro) throw Error("invalid field: expected ORDER > 0, got " + e);
        let c = !1;
        ...
        let { nBitLength: u, nByteLength: l } = rS(e, i);
        if (l > 2048)
        ...
        let d = Object.freeze({
          ...
          pow: (e, t) =>
            (function (e, t, n) {
              ...
              if (n === ro) return e.ONE;
              if (n === rc) return t;
              let r = e.ONE,
                a = t;
              for (; n > ro; )
                n & rc && (r = e.mul(r, a)), (a = e.sqr(a)), (n >>= rc);
              return r;
            })(d, e, t),
          div: (t, n) => rg(t * rb(n, e), e),
          sqrN: (e) => e * e,
          addN: (e, t) => e + t,
          subN: (e, t) => e - t,
          mulN: (e, t) => e * t,
      ...
      function rq(e) {
        if (e !== rC) throw Error("invalid wNAF");
      }
      class rF {
        constructor(e, t) {
          (this.BASE = e.BASE),
        ...
        _unsafeLadder(e, t, n = this.ZERO) {
          let r = e;
          for (; t > rC; )
            t & rT && (n = n.add(r)), (r = r.double()), (t >>= rT);
          return n;
        }
        precomputeWindow(e, t) {
          let { windows: n, windowSize: r } = rN(t, this.bits),
            a = [],
            i = e,
            s = i;
          for (let e = 0; e < n; e++) {
        ...
        wNAF(e, t, n) {
          ...
          for (let e = 0; e < i.windows; e++) {
            ...
            (n = s), c ? (a = a.add(rj(l, t[d]))) : (r = r.add(rj(u, t[o])));
          }
          return rq(n), { p: r, f: a };
        }
        wNAFUnsafe(e, t, n, r = this.ZERO) {
          let a = rN(e, this.bits);
          for (let e = 0; e < a.windows && n !== rC; e++) {
            let { nextN: i, offset: s, isZero: o, isNeg: c } = rD(n, e, a);
            if (((n = i), !o)) {
              let e = t[s];
        ...
        getPrecomputes(e, t, n) {
          ...
          return (
            r ||
              ...
              1 !== e && ("function" == typeof n && (r = n(r)), rB.set(t, r))),
            r
          );
        }
        cached(e, t, n) {
        ...
        createCache(e, t) {
          rL(t, this.bits), rU.set(e, t), rB.delete(e);
        }
        hasCache(e) {
          return 1 !== rR(e);
        }
      ...
      function rH(e, t, n) {
        if (!t) return rI(e, { isLE: n });
        if (t.ORDER !== e)
          throw Error("Field.ORDER must match order: Fp == p, Fn == n");
        return (
          ri(
            t,
            rk.reduce((e, t) => ((e[t] = "function"), e), {
              ORDER: "bigint",
              MASK: "bigint",
              BYTES: "number",
              BITS: "number",
      ...
      function rW(e, t) {
        ...
        return (
          n5(n.lowS, "lowS"),
          n5(n.prehash, "prehash"),
          void 0 !== n.format && rz(n.format),
          n
        );
      }
        ...
        let n = (t) =>
          (function (e) {
              ...
              i = (function (e, t, n = {}) {
                ...
                let r = n.randomBytes || n_,
                  ...
                  { ORDER: o, BITS: c } = s,
                  {
                    ...
                    let { Fn: n } = e,
                      r = t.randomBytes || n_,
                      a = Object.assign(r1(e.Fp, n), { seed: rP(n.ORDER) });
                    function i(e) {
                      try {
                        return !!rX(n, e);
                      } catch (e) {
                    ...
                    function s(e = r(a.seed)) {
                      return (function (e, t, n = !1) {
                        ...
                        let s = rg(n ? n7(e) : n8(np(e)), t - rc) + rc;
                        return n ? re(s, a) : n9(s, a);
                      })(n6(e, a.seed, "seed"), n.ORDER);
                    }
                    function o(t, r = !0) {
                      return e.BASE.multiply(rX(n, t)).toBytes(r);
                    }
                    function c(t) {
                    ...
                    return Object.freeze({
                      ...
                      utils: {
                        ...
                        isValidPrivateKey: i,
                        randomPrivateKey: s,
                        normPrivateKeyToScalar: (e) => rX(n, e),
                ...
                class g {
                  ...
                  static fromBytes(e, t = m) {
                    ...
                    let r = s.BYTES,
                      a = e.subarray(0, r),
                      i = e.subarray(r, 2 * r);
                    return new g(s.fromBytes(a), s.fromBytes(i), n);
                  }
                  static fromHex(e, t) {
                  ...
                  toBytes(e = m) {
                    if ((rz(e), "der" === e)) return ny(rK.hexFromSig(this));
                    let t = s.toBytes(this.r),
                      n = s.toBytes(this.s);
                    if ("recovered" === e) {
                      if (null == this.recovery)
                        throw Error("recovery bit must be present");
                      return nb(Uint8Array.of(this.recovery), t, n);
                    }
                    return nb(t, n);
                  }
                  toHex(e) {
                    return np(this.toBytes(e));
                  }
                  assertValidity() {}
                  static fromCompact(e) {
                    return g.fromBytes(rt("sig", e), "compact");
                  }
                  static fromDER(e) {
                    return g.fromBytes(rt("sig", e), "der");
                  }
                  normalizeS() {
                    return this.hasHighS()
                      ? new g(this.r, s.neg(this.s), this.recovery)
                      : this;
                  }
                  toDERRawBytes() {
                  ...
                  toDERHex() {
                    return np(this.toBytes("der"));
                  }
                  toCompactRawBytes() {
                    return this.toBytes("compact");
                  }
                  toCompactHex() {
                    return np(this.toBytes("compact"));
                  }
                }
                let b =
                    n.bits2int ||
                ...
                function x(e, n) {
                  return (
                    n6(e, void 0, "message"),
                    n ? n6(t(e), void 0, "prehashed message") : e
                  );
                }
                return Object.freeze({
                  keygen: u,
                  ...
                  sign: function (n, i, c = {}) {
                    let { seed: u, k2sig: l } = (function (t, n, a) {
                      ...
                      let { lowS: i, prehash: c, extraEntropy: u } = rW(a, h),
                        l = w((t = x(t, c))),
                        d = rX(s, n),
                        f = [_(d), _(l)];
                      if (null != u && !1 !== u) {
                        let e = !0 === u ? r(p.secretKey) : u;
                        f.push(rt("extraEntropy", e));
                      }
                      return {
                        seed: nb(...f),
                        k2sig: function (t) {
                          ...
                          if (u === rV) return;
                          let f = (2 * (a.x !== c)) | Number(a.y & rZ),
                            p = u;
                          return (
                            i && u > o >> rZ && ((p = s.neg(u)), (f ^= 1)),
                            new g(c, p, f)
                          );
                        },
                      };
                  ...
                  verify: function (t, n, r, a = {}) {
                    let { lowS: i, prehash: o, format: c } = rW(a, h);
                    if (
                      ((r = rt("publicKey", r)),
                      (n = x(rt("message", n), o)),
                      "strict" in a)
                    ...
                    let u =
                      void 0 === c
                        ? (function (e) {
                            ...
                            if (r) t = new g(e.r, e.s);
                            else if (n) {
                              try {
                                t = g.fromBytes(rt("sig", e), "der");
                              } catch (e) {
                                if (!(e instanceof rK.Err)) throw e;
                              }
                              if (!t)
                                try {
                                  t = g.fromBytes(rt("sig", e), "compact");
                                } catch (e) {
                                  return !1;
                                }
                            }
                  ...
                  recoverPublicKey: function (e, t, n = {}) {
                    let { prehash: r } = rW(n, h);
                    return (
                      (t = x(t, r)),
                      g.fromBytes(e, "recovered").recoverPublicKey(t).toBytes()
                    );
                  },
                  Signature: g,
                  hash: t,
                ...
                (function (e, t = {}) {
                  ...
                  let d =
                      ...
                      function (e, t, n) {
                        let { x: a, y: i } = t.toAffine(),
                          s = r.toBytes(a);
                        return (n5(n, "isCompressed"), n)
                          ? (l(), nb(r0(!r.isOdd(i)), s))
                          : nb(Uint8Array.of(4), s, r.toBytes(i));
                      },
                    f =
                      t.fromBytes ||
                      function (e) {
                  ...
                  function w(e) {
                    ...
                    return (function (e, t, n) {
                      let [[r, a], [i, s]] = t,
                        ...
                        f = l < rV;
                      d && (u = -u), f && (l = -l);
                      let p = ra(Math.ceil(rr(n) / 2)) + rZ;
                      if (u < rV || u >= p || l < rV || l >= p)
                        throw Error(
                  ...
                  class k {
                    ...
                    static fromBytes(e) {
                      let t = k.fromAffine(f(n6(e, void 0, "point")));
                      return t.assertValidity(), t;
                    }
                    static fromHex(e) {
                      return k.fromBytes(rt("pointHex", e));
                    }
                    get x() {
                    ...
                    precompute(e = 8, t = !0) {
                      return (
                        A.createCache(this, e), t || this.multiply(rQ), this
                      );
                    }
                    assertValidity() {
                      _(this);
                    ...
                    multiplyUnsafe(e) {
                      ...
                      if (!a.isValid(e))
                        throw Error("invalid scalar: out of range");
                      if (e === rV || this.is0()) return k.ZERO;
                      if (e === rZ) return this;
                    ...
                    isTorsionFree() {
                      ...
                      return (
                        s === rZ || (e ? e(k, this) : A.unsafe(this, o).is0())
                      );
                    }
                    clearCofactor() {
                  ...
                  (k.BASE = new k(i.Gx, i.Gy, r.ONE)),
                    ...
                    (k.Fn = a);
                  let E = a.BITS,
                    A = new rF(k, t.endo ? Math.ceil(E / 2) : E);
            ...
            return Object.assign({}, i, {
              ProjectivePoint: s,
              CURVE: Object.assign({}, e, rS(s.Fn.ORDER, s.Fn.BITS)),
            });
          })({ ...e, hash: t });
        return { ...n(t), create: n };
      }
      let r3 = {
        ...
        r8 = rI(r5.p),
        r7 = rI(r6.p),
        r9 = r2({ ...r3, Fp: r4, lowS: !1 }, nQ);
      r2({ ...r5, Fp: r8, lowS: !1 }, nX),
        r2(
          {
            ...r6,
            Fp: r7,
      ...
      class ae extends Error {
        constructor(e, t = {}) {
          let n = (() => {
            ...
            r = (t.cause instanceof ae && t.cause.docsPath) || t.docsPath,
            a = `https://oxlib.sh${r ?? ""}`;
          super(
            [
              e || "An error occurred.",
      ...
      function an(e, t) {
        if (ap(e) > t) throw new ag({ givenSize: ap(e), maxSize: t });
      }
      function ar(e, t = {}) {
      ...
      function ac(e, t = {}) {
        let n = "";
        for (let t = 0; t < e.length; t++) n += ai[e[t]];
        let r = `0x${n}`;
        return "number" == typeof t.size ? (an(r, t.size), ad(r, t.size)) : r;
      }
      function au(e, t = {}) {
        var n;
        let r,
        ...
        let c = (a && s < 0 ? (1n << BigInt(8 * i)) + BigInt(s) : s).toString(
          ...
          u = `0x${c}`;
        return i ? ((n = u), ar(n, { dir: "left", size: i })) : u;
      }
      function al(e, t = {}) {
        return ac(aa.encode(e), t);
      }
      function ad(e, t) {
      ...
      function af(e, t, n, r = {}) {
        let { strict: a } = r;
        if ("number" == typeof t && t > 0 && t > ap(e) - 1)
          throw new ab({ offset: t, position: "start", size: ap(e) });
        let i = `0x${e
          .replace("0x", "")
          ...
          a &&
            (function (e, t, n) {
              if (
                ...
                throw new ab({ offset: n, position: "end", size: ap(e) });
            })(i, t, n),
          i
        );
      }
      ...
      let av = { zero: 48, nine: 57, A: 65, F: 70, a: 97, f: 102 };
      function a_(e) {
        return e >= av.zero && e <= av.nine
          ? e - av.zero
          : e >= av.A && e <= av.F
          ? e - (av.A - 10)
          : e >= av.a && e <= av.f
      ...
      function aS(e, t, n, r = {}) {
        let { strict: a } = r;
        if ("number" == typeof t && t > 0 && t > aA(e) - 1)
          throw new aC({ offset: t, position: "start", size: aA(e) });
        let i = e.slice(t, n);
        return (
          a &&
            (function (e, t, n) {
              if (
                ...
                throw new aC({ offset: n, position: "end", size: aA(e) });
            })(i, t, n),
          i
        );
      }
      function aI(e, t = {}) {
        ...
        return (
          void 0 !== n &&
            (function (e, t) {
              if (aA(e) > t) throw new aP({ givenSize: aA(e), maxSize: t });
            })(e, n),
          (function (e, t = {}) {
            let { signed: n } = t;
            t.size && an(e, t.size);
      ...
      function aT(e, t = {}) {
        ...
        if (!1 === n || ("bigint" == typeof a && "bigint" == typeof i)) {
          if (4 !== r) throw new aN({ prefix: r, cause: new aB() });
          return;
        }
        if (!0 === n || ("bigint" == typeof a && void 0 === i)) {
          if (3 !== r && 2 !== r) throw new aN({ prefix: r, cause: new aD() });
          return;
        }
        throw new aL({ publicKey: e });
      }
      function aj(e) {
        if (132 !== e.length && 130 !== e.length && 68 !== e.length)
          throw new aU({ publicKey: e });
        if (130 === e.length)
          return {
            prefix: 4,
            x: BigInt(af(e, 0, 32)),
        ...
        return { prefix: Number(af(e, 0, 1)), x: BigInt(af(e, 1, 33)) };
      }
      function aM(e, t = {}) {
        aT(e);
        ...
        return as(
          i ? au(n, { size: 1 }) : "0x",
          au(r, { size: 32 }),
          "bigint" == typeof a ? au(a, { size: 32 }) : "0x"
        );
      }
      class aL extends ae {
        constructor({ publicKey: e }) {
          super(`Value \`${at(e)}\` is not a valid public key.`, {
            metaMessages: [
                ...
                (function (e, t = {}) {
                  ...
                  try {
                    return (
                      !(function (e, t = {}) {
                        let { strict: n = !1 } = t;
                        if (!e || "string" != typeof e) throw new am(e);
                        if (
      ...
      async function aq(e) {
        let { payload: t, privateKey: n } = e,
          ...
          a = aI(aS(r, 0, 32)),
          i = aI(aS(r, 32, 64));
        return i > r9.CURVE.n / 2n && (i = r9.CURVE.n - i), { r: a, s: i };
      }
      let aF = new TextDecoder(),
      ...
      function aW(e) {
        if (130 !== e.length && 132 !== e.length)
          throw new a$({ signature: e });
        let t = BigInt(af(e, 0, 32)),
          n = BigInt(af(e, 32, 64)),
          r = (() => {
            ...
            if (!Number.isNaN(t))
              try {
                ...
                throw new aQ({ value: n });
              } catch {
                throw new aJ({ value: t });
              }
          })();
      ...
      let a1 = "activeId",
        a2 = (function (e, t) {
          let n = "undefined" != typeof indexedDB ? (0, a0.y$)(e, t) : void 0;
          return {
            getItem: async (e) => {
              let t = await (0, a0.Jt)(e, n);
              return t || null;
            },
            removeItem: async (e) => (0, a0.yH)(e, n),
            setItem: async (e, t) => (0, a0.hZ)(e, t, n),
          };
        })("cbwsdk", "keys");
      async function a3() {
        let e = await aR({ extractable: !1 }),
          t = af(aM(e.publicKey), 1);
        return await a2.setItem(t, e), await a2.setItem(a1, t), e;
      }
      async function a5() {
        let e = await a2.getItem(a1);
        if (!e) return null;
        let t = await a2.getItem(e);
        return t || null;
      }
      async function a6() {
        let e = await a5();
      ...
      async function a4() {
              ...
              let {
                ...
                u = (function (e = {}) {
                  let {
                    ...
                    a = aG(al(n));
                  return as(a, au(t, { size: 1 }), au(r, { size: 4 }));
                    ...
                    challenge: (function (e, t = {}) {
                      return (function (e, t = {}) {
                        ...
                        let i = e.length % 3,
                          ...
                          o = aF.decode(new Uint8Array(a.buffer, 0, s));
                        return (
                          n && 1 === i && (o += "=="),
                          n && 2 === i && (o += "="),
                          r &&
            ...
            return {
              signature: (function (e) {
                !(function (e, t = {}) {
                  ...
                  if (e.r < 0n || e.r > az) throw new aV({ value: e.r });
                  if (e.s < 0n || e.s > az) throw new aZ({ value: e.s });
                  if (
                    "number" == typeof e.yParity &&
                    0 !== e.yParity &&
                    1 !== e.yParity
                  )
                    throw new aJ({ value: e.yParity });
                })(e);
                let t = e.r,
                  n = e.s;
                return as(
                  ...
                  "number" == typeof e.yParity
                    ? au(
                        (function (e) {
                          if (0 === e) return 27;
                          if (1 === e) return 28;
                          throw new aJ({ value: e });
                        })(e.yParity),
                        { size: 1 }
                      )
                    : "0x"
                );
              })(await aq({ payload: n, privateKey: e.privateKey })),
              raw: {},
              webauthn: r,
            };
          };
        return {
          ...
          signMessage: async ({ message: e }) => n((0, aY.A)(e)),
          signTypedData: async (e) => n((0, aX.Zh)(e)),
          type: "webAuthn",
        };
      }
      async function a8() {
        return { account: await a4() };
      }
      let a7 = { storageKey: "ownPrivateKey", keyType: "private" },
        a9 = { storageKey: "ownPublicKey", keyType: "public" },
      ...
      class it {
        ...
        async generateKeyPair() {
          ...
          (this.ownPrivateKey = e.privateKey),
            ...
            await this.storeKey(a7, e.privateKey),
            await this.storeKey(a9, e.publicKey);
        }
        async loadKeysIfNeeded() {
          null === this.ownPrivateKey &&
            (this.ownPrivateKey = await this.loadKey(a7)),
            null === this.ownPublicKey &&
              (this.ownPublicKey = await this.loadKey(a9)),
            (null === this.ownPrivateKey || null === this.ownPublicKey) &&
              (await this.generateKeyPair()),
            null === this.peerPublicKey &&
              (this.peerPublicKey = await this.loadKey(ie)),
            null === this.sharedSecret &&
              null !== this.ownPrivateKey &&
              null !== this.peerPublicKey &&
              (this.sharedSecret = await t5(
                this.ownPrivateKey,
                this.peerPublicKey
              ));
        }
        async loadKey(e) {
          let t = b.keys.get(e.storageKey);
          return t ? t9(e.keyType, t) : null;
        }
        async storeKey(e, t) {
          let n = await t7(e.keyType, t);
          b.keys.set(e.storageKey, n);
        }
      }
      var ir = n(44352),
        ia = n(80329);
      ...
      function iu(e, t) {
        ...
        if (t && e.method.startsWith("wallet_")) {
          let e = ii(n, "params.0.capabilities");
      ...
      async function il() {
        var e;
        let t = null != (e = b.subAccountsConfig.get()) ? e : {},
          n = {};
        ...
        b.subAccountsConfig.set({ capabilities: n });
      }
      async function id({ client: e, id: t }) {
        var n;
        let r = await (0, is.c)(e, { id: t });
        if ("success" === r.status)
          return null == (n = r.receipts) ? void 0 : n[0].transactionHash;
        throw C.rpc.internal("failed to send transaction");
      }
      function ip({ calls: e, from: t, chainId: n, capabilities: r }) {
        let a = g.get().paymasterUrls,
          i = {
            method: "wallet_sendCalls",
            params: [
              {
      ...
      async function ig() {
        let e = b.spendPermissions.get(),
          t = b.subAccounts.get(),
          n = b.account.get().accounts;
        return n
          ? {
              accounts:
                null == n
          ...
          ...(e.sign
            ? {
                async sign(t) {
                  ...
                  return n && r ? iM({ address: n, data: r, signature: a }) : a;
                },
              }
            : {}),
          async signMessage(t) {
            ...
            return n && r && "0x7702" !== n
              ? iM({ address: n, data: r, signature: a })
              : a;
          },
      ...
      function iN(e) {
        ...
        if (
          ...
          let e = t.address;
          return (0, tD.xW)([e, r ?? "0x"]);
        }
        return n ? (0, tD.xW)([n, r ?? "0x"]) : "0x";
      }
      function iD(e) {
        let {
            callGasLimit: t,
      ...
      async function iR(e) {
        ...
        return iL({
          client: a,
          entryPoint: s,
          extend: { abi: _, factory: o },
          async decodeCalls(e) {
            let t = (0, i_.J)({ abi: _, data: e });
          ...
          async sign(e) {
            ...
            return iH({
              ownerIndex: n,
              signature: await iq({ hash: r, owner: t }),
            });
          },
          async signMessage(e) {
            let { message: r } = e,
            ...
            return iH({
              ownerIndex: n,
              signature: await iq({ hash: i, owner: t }),
            });
          },
          async signTypedData(e) {
            ...
            return iH({
              ownerIndex: n,
              signature: await iq({ hash: c, owner: t }),
            });
          },
      ...
      async function iq({ hash: e, owner: t }) {
        if ("webAuthn" === t.type) {
      ...
      function iF({ address: e, chainId: t, hash: n }) {
        return (0, aX.Zh)({
          domain: {
            chainId: t,
      ...
      function iH(e) {
        let { ownerIndex: t = 0 } = e,
          n = (() => {
            if (65 !== (0, ik.E)(e.signature)) return e.signature;
            let t = (function (e) {
              let { r: t, s: n } = iE.secp256k1.Signature.fromCompact(
                  e.slice(2, 130)
                ),
            ...
            return (function (e, t) {
              ...
              for (let r = 0; r < e.length; r++) {
                ...
                n.push(
                  (function e(t, n, r = !1) {
                    if ("address" === t) {
                      if (!(0, t0.P)(n)) throw new iS.M({ address: n });
                    ...
                    if (s && Array.isArray(n)) {
                      ...
                      return 0 === a.length ? "0x" : (0, tD.aP)(a);
                    }
                    throw new iA.Wl(t);
                  })(a, i)
                );
              ...
              switch (e.method) {
                ...
                case "eth_sendTransaction": {
                  ...
                  let s = {
                    ...
                    o = ip({ calls: [s], chainId: d, from: s.from }),
                    c = await p(o);
                  return id({ client: t, id: c });
                }
                case "wallet_sendCalls": {
                  let t;
                  R(e.params);
                  let n = ii(e.params[0], "chainId");
                            ...
                            signature: JSON.stringify(
                              (function ({ webauthn: e, signature: t, id: n }) {
                                ...
                                return {
                                  ...
                                  rawId: iv((0, ib.Af)(n)),
                                  response: {
                                    authenticatorData: iv(
                                      (0, ib.aT)(e.authenticatorData)
                                    ),
                                    clientDataJSON: iv(
                                      (0, ib.Af)(e.clientDataJSON)
                                    ),
                                    signature: iv(
                                      (function (e, t) {
                                        let n = (0, ib.aT)(
                ...
                case "personal_sign": {
                  if ((R(e.params), !(0, t1.q)(e.params[0])))
                    throw C.rpc.invalidParams(
              ...
              if (B(e)) {
                let t = (function (e) {
                  try {
                    ...
                    return new L(t.code, t.message, t.data);
                  } catch (e) {
                    return null;
                  }
                })(e);
      ...
      async function iW({
        ...
        if (!(await (0, iC.Q)(t, { address: e })) && r && a) {
          if ((0, iz.b)(r) !== (0, iz.b)(w))
            throw C.rpc.internal("unknown factory address");
          let e = (0, i_.J)({ abi: x, data: a });
          if ("createAccount" !== e.functionName)
            throw C.rpc.internal("unknown factory function");
          let [t] = e.args;
          return t.findIndex((e) => e.toLowerCase() === i$(n).toLowerCase());
        }
        let i = await (0, iT.J)(t, {
          address: e,
          abi: _,
          functionName: "ownerCount",
        });
        for (let r = Number(i) - 1; r >= 0; r--) {
          let a = await (0, iT.J)(t, {
              address: e,
              abi: _,
      ...
      async function iV({ ownerAccount: e, globalAccountRequest: t }) {
        var n, r;
        let a = b.account.get(),
          i = b.subAccounts.get(),
          s =
        ...
        if (
          ...
          "success" !== (await (0, is.c)(p, { id: f })).status)
        )
      ...
      async function iJ({
        ...
        if (
          ...
          p = ip({ calls: [a.params[0]], chainId: h, from: a.params[0].from })
            .params[0];
        ...
        let b = [
          ...
          w = await s({
            method: "wallet_sendCalls",
            params: [
              Object.assign(Object.assign({}, p), { calls: b, from: t }),
            ],
          });
      ...
      class iQ {
        constructor(e) {
          ...
          (this.communicator = e.communicator),
            ...
            (this.keyManager = new it());
          let { account: i, chains: s } = b.getState();
        ...
        async handshake(e) {
            ...
            K(
              "scw_signer.handshake.started",
              {
                ...
                enableAutoSubAccounts:
                  null == (n = b.subAccountsConfig.get())
                    ? void 0
          ...
          try {
            ...
            let l = await t9("public", u.sender);
              ...
              ((({ method: e, correlationId: t, errorMessage: n }) => {
                ...
                K(
                  "scw_signer.handshake.error",
                  {
                    ...
                    errorMessage: n,
                    enableAutoSubAccounts:
                      null == (s = b.subAccountsConfig.get())
                        ? void 0
        ...
        async _request(e) {
          var t, n, s, o, c, l, d, f, p, h, m, y, g, w;
          if (0 === this.accounts.length)
            switch (e.method) {
              ...
              case "wallet_switchEthereumChain":
                ic(e.params), (this.chain.id = Number(e.params[0].chainId));
                return;
              case "wallet_connect": {
                ...
                (function (e, t) {
                  ...
                  (t =
                    null !=
                    (f =
                      null == (d = b.subAccountsConfig.get())
                        ? void 0
                        : d.capabilities)
                      ? f
                      : {});
          ...
          switch (e.method) {
            case "eth_requestAccounts":
            case "eth_accounts": {
              let e = b.subAccounts.get(),
                t = b.subAccountsConfig.get();
              return (
                (null == e ? void 0 : e.address) &&
                  (this.accounts = (
                    null == t ? void 0 : t.enableAutoSubAccounts
                  )
                    ? im(this.accounts, e.address)
            ...
            case "wallet_connect": {
              ...
              await (null == (m = (h = this.communicator).waitForPopupLoaded)
                ...
                : m.call(h)),
                await il();
              let n = b.subAccountsConfig.get(),
                r = iu(
                  e,
                  null != (y = null == n ? void 0 : n.capabilities) ? y : {}
                );
              return (
                null == (g = this.callback) ||
                  g.call(this, "connect", {
                    chainId: (0, u.cK)(this.chain.id),
                  }),
            ...
            case "coinbase_fetchPermissions": {
              ...
              let t = (function (e) {
                  ...
                  let a =
                      null == (t = b.getState().account.accounts)
                        ? void 0
                        : t[0],
                    i =
                      null == (n = b.getState().account.chain) ? void 0 : n.id,
                    s =
                      null == (r = b.getState().subAccount)
                        ? void 0
                        : r.address;
                  if (!a || !s || !i)
                    throw C.rpc.invalidParams(
        ...
        async handleResponse(e, t) {
          ...
          switch (e.method) {
            case "eth_requestAccounts": {
              let e = o.value;
              (this.accounts = e),
                b.account.set({ accounts: e, chain: this.chain }),
            ...
            case "wallet_connect": {
              ...
              (this.accounts = t), b.account.set({ accounts: t });
              ...
              d &&
                "permissions" in d &&
                b.spendPermissions.set(null == d ? void 0 : d.permissions),
        ...
        async cleanup() {
          var e, t;
          let n = b.config.get().metadata;
          await this.keyManager.clear(),
            b.account.clear(),
            b.subAccounts.clear(),
            b.spendPermissions.clear(),
            b.chains.clear(),
            (this.accounts = []),
            (this.chain = {
              id:
        ...
        async handleGetCapabilitiesRequest(e) {
          ...
          let a = b.getState().account.capabilities;
          if (!a) return {};
        ...
        async sendEncryptedRequest(e) {
          ...
          let n = await ne({ action: e, chainId: this.chain.id }, t),
            r = eD.get(e),
        ...
        async createRequestMessage(e, t) {
          let n = await t7("public", await this.keyManager.getOwnPublicKey());
          return {
            id: crypto.randomUUID(),
            correlationId: t,
            sender: n,
        ...
        async decryptResponseMessage(e) {
          ...
          if (o) {
            ...
            b.chains.set(t), this.updateChain(this.chain.id, t), tY(t);
          }
          let c = null == (r = s.data) ? void 0 : r.capabilities;
          return c && b.account.set({ capabilities: c }), s;
        }
        updateChain(e, t) {
          var n;
          let r = b.getState(),
        ...
        async addSubAccount(e) {
          var t, n, r, a;
          let i = b.getState().subAccount,
            s = b.subAccountsConfig.get();
          if (null == i ? void 0 : i.address)
            return (
              (this.accounts = (null == s ? void 0 : s.enableAutoSubAccounts)
                ? im(this.accounts, i.address)
          ...
          if (
            ...
            if (e.params[0].account.keys && e.params[0].account.keys.length > 0)
              ...
              let e = null != (a = b.subAccountsConfig.get()) ? a : {},
          ...
          let f = (function ({ attribution: e, dappOrigin: t }) {
              if (e) {
                if ("auto" in e && e.auto && t)
                  return (0, ir.di)((0, ia.S)((0, u.nj)(t)), 0, 16);
      ...
      class i3 {
        ...
        constructor(e, t = WebSocket) {
          (this.WebSocketClass = t),
            ...
            (this.instanceId = i3.instanceCounter++),
            i3.activeInstances.add(this.instanceId);
        }
        async connect() {
            ...
            null == (n = this.connectionStateListener) ||
              ...
              (r.onopen = (t) => {
                ...
                e(),
                  ...
                  i3.pendingData.length > 0 &&
                    ([...i3.pendingData].forEach((e) => this.sendData(e)),
                    (i3.pendingData = []));
              }),
              (r.onmessage = (e) => {
                var t, n;
        ...
        sendData(e) {
          let { webSocket: t } = this;
          if (!t) {
            i3.pendingData.push(e), this.isDisconnecting || this.connect();
            return;
          }
          if (t.readyState !== WebSocket.OPEN)
            return void i3.pendingData.push(e);
          t.send(e);
        }
        clearWebSocket() {
        ...
        cleanup() {
          i3.activeInstances.delete(this.instanceId);
        }
      }
      (i3.instanceCounter = 0),
        (i3.activeInstances = new Set()),
        (i3.pendingData = []);
      class i5 {
        constructor({ session: e, linkAPIUrl: t, listener: n }) {
          (this.destroyed = !1),
            ...
            (this.session = e),
            (this.cipher = new i1(e.secret)),
            (this.listener = n),
            (this.linkAPIUrl = t),
            (this.WebSocketClass = WebSocket);
          let r = this.createWebSocket();
          (this.ws = r),
            (this.http = new i2(t, e.id, e.key)),
            this.setupVisibilityChangeHandler();
        }
        createWebSocket() {
          let e = new i3(`${this.linkAPIUrl}/rpc`, this.WebSocketClass);
          return (
      ...
      let i7 = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength),
        i9 = (e, t) => (e << (32 - t)) | (e >>> t);
      new Uint8Array(new Uint32Array([0x11223344]).buffer)[0];
      let se = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, "0")
      );
      function st(e) {
        return (
      ...
      let sr = (e, t, n) => (e & t) ^ (~e & n),
        sa = (e, t, n) => (e & t) ^ (e & n) ^ (t & n);
      class si extends sn {
        constructor(e, t, n, r) {
          super(),
            (this.blockLen = e),
      ...
      class su extends si {
        ...
        process(e, t) {
          ...
          for (let e = 16; e < 64; e++) {
            let t = sc[e - 15],
              n = sc[e - 2],
              r = i9(t, 7) ^ i9(t, 18) ^ (t >>> 3),
              a = i9(n, 17) ^ i9(n, 19) ^ (n >>> 10);
          ...
          for (let e = 0; e < 64; e++) {
            let t =
                (u +
                  (i9(s, 6) ^ i9(s, 11) ^ i9(s, 25)) +
                  sr(s, o, c) +
                  ss[e] +
                  sc[e]) |
                0,
              l = ((i9(n, 2) ^ i9(n, 13) ^ i9(n, 22)) + sa(n, r, a)) | 0;
            (u = c),
              (c = o),
              (o = s),
              (s = (i + t) | 0),
      ...
      class sh {
        ...
        static create(e) {
          return new sh(e, eb(16), eb(32)).save();
        }
        static load(e) {
          let t = e.getItem(sd),
            n = e.getItem(sp),
            r = e.getItem(sf);
          return t && r ? new sh(e, t, r, "1" === n) : null;
        }
        get linked() {
          return this._linked;
        }
        ...
        save() {
          return (
            this.storage.setItem(sd, this.id),
            this.storage.setItem(sf, this.secret),
            this.persistLinked(),
            this
          );
        }
        persistLinked() {
          this.storage.setItem(sp, this._linked ? "1" : "0");
        }
      }
      class sm {
        constructor() {
      ...
      class sg {
        constructor() {
          (this.attached = !1), (this.redirectDialog = new sm());
        }
        attach() {
          if (this.attached)
            throw Error("Coinbase Wallet SDK UI is already attached");
      ...
      class sb {
        constructor(e) {
          (this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }),
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                sb.accountRequestCallbackIds.size > 0 &&
                  (Array.from(sb.accountRequestCallbackIds.values()).forEach(
                    (t) => {
                  ...
                  sb.accountRequestCallbackIds.clear());
            }),
          ...
          (this._session = t),
            (this.connection = r),
            (this.relayEventManager = new i6()),
            (this.ui = n),
            this.ui.attach();
        }
        subscribe() {
          let e = sh.load(this.storage) || sh.create(this.storage),
            { linkAPIUrl: t } = this,
            n = new i5({ session: e, linkAPIUrl: t, listener: this }),
            r = this.isMobileWeb ? new sg() : new ei();
        ...
        handleWeb3ResponseMessage(e, t) {
          if ("requestEthereumAccounts" === t.method) {
            sb.accountRequestCallbackIds.forEach((e) =>
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(r, (n) => {
              ...
              sb.accountRequestCallbackIds.add(r),
      ...
      sb.accountRequestCallbackIds = new Set();
      var sw = n(81029).Buffer;
      let sv = "DefaultChainId",
        s_ = "DefaultJsonRpcUrl";
      class sx {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
          ...
          let t = this._storage.getItem(i0);
          if (t) {
            let e = t.split(" ");
        ...
        get jsonRpcUrl() {
          var e;
          return null != (e = this._storage.getItem(s_)) ? e : void 0;
        }
        set jsonRpcUrl(e) {
          this._storage.setItem(s_, e);
        }
        updateProviderInfo(e, t) {
          var n;
          this.jsonRpcUrl = e;
          let r = this.getChainId();
          this._storage.setItem(sv, t.toString(10)),
            eM(t) !== r &&
              (null == (n = this.callback) ||
        ...
        _setAddresses(e, t) {
          ...
          JSON.stringify(r) !== JSON.stringify(this._addresses) &&
            ...
            this._storage.setItem(i0, r.join(" ")));
        }
        async request(e) {
          let t = eD.get(e);
          (({ method: e, correlationId: t }) => {
        ...
        _prepareTransactionParams(e) {
          ...
          let n = e.to ? eT(e.to) : null,
            r = null != e.value ? eL(e.value) : BigInt(0),
            a = e.data ? ej(e.data) : sw.alloc(0),
            i = null != e.nonce ? eM(e.nonce) : null,
            s = null != e.gasPrice ? eL(e.gasPrice) : null,
            o = null != e.maxFeePerGas ? eL(e.maxFeePerGas) : null,
            c =
              null != e.maxPriorityFeePerGas
                ? eL(e.maxPriorityFeePerGas)
                : null;
          return {
            fromAddress: t,
            toAddress: n,
            ...
            maxFeePerGas: o,
            maxPriorityFeePerGas: c,
            gasLimit: null != e.gas ? eL(e.gas) : null,
            chainId: e.chainId ? eM(e.chainId) : this.getChainId(),
          };
        }
        async ecRecover(e) {
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null != (e = this._storage.getItem(sv)) ? e : "1",
            10
          );
        }
          ...
          let i = this.initializeRelay(),
            s = await i.sendRequest({
              ...
              params: {
                ...
                message: e_(
                  {
                    eth_signTypedData_v1: iX.hashForSignTypedDataLegacy,
                    eth_signTypedData_v3: iX.hashForSignTypedData_v3,
                    eth_signTypedData_v4: iX.hashForSignTypedData_v4,
                    eth_signTypedData: iX.hashForSignTypedData_v4,
                  }[t]({
                    data: (function (e) {
      ...
      let sk = "SignerType",
        sE = new ep("CBWSDK", "SignerConfigurator");
      function sA(e) {
        if (e) return e instanceof iQ ? "scw" : "walletlink";
      }
      async function sS(e) {
        let {
          communicator: t,
      ...
      async function sI(e, t, n, r) {
        ...
        let a = new sx({ metadata: t, callback: n });
        e.postMessage({
      ...
      class sP extends ef {
        ...
        initSigner(e) {
          ...
          switch (t) {
            case "scw":
              return new iQ({ metadata: n, callback: a, communicator: r });
            case "walletlink":
              return new sx({ metadata: n, callback: a });
          }
        }
      }
      let sC = { options: "all" };
          ...
          d = {
            ...
            subAccount: {
              async create(e) {
                ...
                return (
                  U(
                    null == (t = b.getState().subAccount) ? void 0 : t.address,
              ...
              setToOwnerAccount(e) {
                G(e), b.subAccountsConfig.set({ toOwnerAccount: e });
              },
            },
          };
        return d;
      ...
      function P(e, t, n, r, i, s, o, c, u, l, d) {
        ...
        for (
          ...
          null != (h = n.__k[f]) &&
            ...
            h.ref &&
              p.ref != h.ref &&
              (p.ref && N(p.ref, null, h), d.push(h.ref, h.__c || g, h)),
            null == w && null != g && (w = g),
