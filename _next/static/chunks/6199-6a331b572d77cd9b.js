...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6199],
  {
    96199: (e, t, n) => {
      ...
      S.type = "InvalidCheck";
      class b extends u {}
      b.type = "JWTSessionError";
      class m extends u {}
      m.type = "MissingAdapter";
      class _ extends u {}
      _.type = "MissingAdapterMethods";
      class L extends u {}
      ...
      async function q(e, t, n) {
        let s =
          ...
          a = "".concat(z(t), "/").concat(e);
        try {
          var r;
          let e = {
            headers: {
              "Content-Type": "application/json",
              ...((null == s || null == (r = s.headers) ? void 0 : r.cookie)
          ...
          return n.error(new J(e.message, e)), null;
        }
      }
      function z(e) {
        return e.basePath;
      ...
      var Q = n(95704);
      let Y = {
          baseUrl: K(null != (a = Q.env.NEXTAUTH_URL) ? a : Q.env.VERCEL_URL)
            .origin,
          basePath: K(Q.env.NEXTAUTH_URL).path,
          baseUrlServer: K(
            null !=
              (o =
                null != (r = Q.env.NEXTAUTH_URL_INTERNAL)
                  ? r
                  : Q.env.NEXTAUTH_URL)
              ? o
              : Q.env.VERCEL_URL
          ...
          basePathServer: K(
            null != (i = Q.env.NEXTAUTH_URL_INTERNAL) ? i : Q.env.NEXTAUTH_URL
          ).path,
          _lastSync: 0,
          _session: void 0,
          _getSession: () => {},
      ...
      let en = {
        ...
        es = null == (s = c.createContext) ? void 0 : s.call(d, void 0);
      function ea(e) {
        if (!es)
      ...
      async function eo() {
        var e;
        let t = await q("csrf", Y, en);
        return null != (e = null == t ? void 0 : t.csrfToken) ? e : "";
      }
      async function ei() {
        return q("providers", Y, en);
      }
      async function el(e, t, n) {
        var s, a, r;
        let { redirect: o = !0 } = null != t ? t : {},
          i =
            null !=
            (a =
              null != (s = null == t ? void 0 : t.redirectTo)
                ? s
                : null == t
                ? void 0
                : t.callbackUrl)
        ...
        let d = "credentials" === c[e].type,
          ...
          h = ""
            ...
            .concat(e),
          p = await eo(),
          v = await fetch("".concat(h, "?").concat(new URLSearchParams(n)), {
            method: "post",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
              "X-Auth-Return-Redirect": "1",
            },
            body: new URLSearchParams({ ...t, csrfToken: p, callbackUrl: i }),
          }),
          f = await v.json();
        if (o || !(d || u)) {
          let e = null != (r = f.url) ? r : i;
          (window.location.href = e),
            e.includes("#") && window.location.reload();
          return;
        }
        let w = new URL(f.url).searchParams.get("error"),
          y = new URL(f.url).searchParams.get("code");
        return (
          v.ok && (await Y._getSession({ event: "storage" })),
          {
            error: w,
            code: y,
            status: v.status,
      ...
      async function ec(e) {
        ...
        let r =
            null !=
            (n =
              null != (t = null == e ? void 0 : e.redirectTo)
                ? t
                : null == e
                ? void 0
                : e.callbackUrl)
          ...
          l = await fetch("".concat(o, "/signout"), {
            ...
            body: new URLSearchParams({ csrfToken: i, callbackUrl: r }),
          }),
          c = await l.json();
        if (
          (et().postMessage({ event: "session", data: { trigger: "signout" } }),
          null == (s = null == e ? void 0 : e.redirect) || s)
        ) {
          let e = null != (a = c.url) ? a : r;
          (window.location.href = e),
            e.includes("#") && window.location.reload();
          return;
        }
        return await Y._getSession({ event: "storage" }), c;
      }
      function ed(e) {
        if (!es)
          throw Error("React Context is unavailable in Server Components");
        ...
        Y._lastSync = r ? G() : 0;
        let [o, i] = c.useState(
            () => (r && (Y._session = e.session), e.session)
          ),
          [d, u] = c.useState(!r);
        c.useEffect(
          () => (
          ...
          c.useEffect(() => {
            ...
            return (
              et().addEventListener("message", e),
              () => et().removeEventListener("message", e)
            );
          }, []),
          c.useEffect(() => {
